...
await page.waitForSelector('#ctl00_ctl00_ContentPlaceHolderMain_ContentPlaceHolderMainSingle_ppBERegAgent_stdbtnSaveRA_container', { visible: true });
    ...
    await page.type('#ctl00_ctl00_ContentPlaceHolderMain_ContentPlaceHolderMainSingle_ppBEGeneralInfo_BENameCustomFields_AssetDistribution205', payload.Stock_Details.SI_Number_Of_Shares.toString());
    ...
    const og_name=payload.Incorporator_Information.Incorporator_Details.Inc_Name.split(" ");
    const orgFields = [
...
const orgFields1 = [
    ...
    { label: 'txtAddress2', value: payload.Incorporator_Information.Address['Address_Line 2']  || " " },
